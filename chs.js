...
var cnItems = {
    ...
    '': '',
    'Desert dagger +': '沙漠匕首 +',
    'You got Shiny Bush water bottle! (You Own': '你得到了闪光灌木水瓶!(你有',
    'If Otherworld count is greater than 1, monster will drop token (10% chance': '如果异界数量大于1，怪物将掉落令牌(10%的几率)',
    'You got Shiny Cactus water bottle! (You Own': '你得到了闪光仙人掌水瓶!(你有',
    'You got Bush water bottle! (You Own': '你得到了灌木水瓶!(你有',
    'TP gain increase based on Otherworldy Count': '超越点增加基于异界计数',
    'After Universe is broken, chest will drop TP (1/2000 chance': '宇宙破碎后，宝箱会掉落超越点 (1/2000几率)',
    'Comming Soon': '敬请期待',
    'Kor': '韩语',
    'Eng': '英文',
    'Cactus water bottle -': '仙人掌水瓶 -',
    'Bush water bottle -': '灌木水瓶 -',
...
var cnPrefix = {
    ...
    "Oasis Desert Bush (hp: ": "绿洲沙漠灌木 (生命值：",
    "Glasses Cactus (hp: ": "眼镜仙人掌 (生命值：",
    "Spiked Desert Bush (hp: ": "荆棘沙漠灌木 (生命值：",
    "Explosive Desert Bush (hp: ": "爆炸沙漠灌木 (生命值：",
    "Desert Bush (hp: ": "沙漠灌木 (生命值：",
